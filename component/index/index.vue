...
<div class="sacroll-warp">
	...
	<div>
		<el-drawer title="在线招聘系统" :visible.sync="showregister" :direction="direction" :before-close="handleClose1">
	...
	<!-- 登录框 -->
	<div>
		<el-drawer title="在线招聘系统" :visible.sync="showlogin" :direction="direction" :before-close="handleClose">
	...
	<!-- 忘记密码 -->
	<div>
		<el-drawer title="在线招聘系统" :visible.sync="showfind" :direction="direction" :before-close="handleClose2">
			<el-card class="box-card" style="margin-top: 20%;">
