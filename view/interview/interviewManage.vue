        ...
        <el-form ref="elForm" :model="formData" :rules="rules" size="small" label-width="100px">
          <el-col :span="12">
            <el-form-item label="面试日期" prop="interviewdate">
              <el-date-picker v-model="interviewdate" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                :style="{ width: '100%' }" placeholder="请选择面试日期" clearable @input="$forceUpdate()"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="面试时间" prop="interviewTime">
              <el-time-picker v-model="interviewTime" format="HH:mm:ss" value-format="HH:mm:ss"
                :style="{ width: '100%' }" placeholder="请选择面试时间" clearable @input="$forceUpdate()"></el-time-picker>
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
export default {
  ...
  methods: {
    ...
    async handelConfirm() {
      ...
      this.formData.time = moment(`${this.interviewdate} ${this.interviewTime}`, 'YYYY-MM-DD HH:mm:ss').format();
